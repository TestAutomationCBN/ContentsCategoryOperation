...
Public Class ContentsGategoryOperation
    ...
    Private Sub CreateImportXML(ddpath As String, export_filepath As String)
        ...
        catList = utilfunc.ExceltoContentsCategoryList(wb)
        ' XMLファイル生成
        utilfunc.ContentsCategoryListtoXML(catList, export_filepath)
    ...
    Private Sub CreateTestSpecification(ddpath As String, export_filepath As String)
        ...
        'テスト仕様書生成
        utilfunc.ContentsCategoryListtoTest(projectName, catList, export_filepath)
